...
| P4-04 | 417 case source 對齊治理 | done | 415 官方 discoverable D### 已對齊；2 legacy duplicate-row YAML 已轉為 explicit fixtures；目前 handoff 已補記 D060/D061/D062/D063/D064/D065/D066/D067/D068/D069/D070/D072/D073/D074/D077/D078/D079/D080 committed checkpoint，且 D185/D368/D371 已折入 completed official cases（progress=`140 / 415`，remaining=`275`）；default lab baseline 已重建為 5G/2.4G=`WPA2-Personal + 00000000`、6G=`WPA3-Personal + SAE + 00000000`，主 sequence 下一個 ready single-case 入口改為 D081 |
...
| P5-03 | integration tests（mock transport） | done | 已補齊 realistic runtime 測試；最新逐案校正後 `tests/test_wifi_llapi_plugin_runtime.py=209 passed`、full suite `262 passed` |

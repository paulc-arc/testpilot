...
- blocker-style handoff now lives at `plugins/wifi_llapi/reports/D204_block.md`; compare is now `320 / 420 full matches` / `100 mismatches` / `58 metadata drifts`, and the next ready non-blocked compare-open case moves to `D208 Radio.OfdmaEnable`
...
- refreshed overlay compare is now `320 / 420 full matches` / `100 mismatches` / `58 metadata drifts`
...
- next ready non-blocked compare-open case: `D208 Radio.OfdmaEnable`

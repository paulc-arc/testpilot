...
- refreshed overlay compare is now `315 / 420 full matches` / `105 mismatches` / `58 metadata drifts`
...
- next ready non-blocked compare-open case: `D201 Radio.ImplicitBeamFormingSupported`

...
- active audit RID is `74ada64b-2026-05-07T134956Z` against local-only workbook `audit/0506.xlsx`; current buckets are `confirmed=163`, `applied=8`, `pending=106`, `block=138`, `needs_pass3=0`

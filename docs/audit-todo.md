...
- active audit RID is `74ada64b-2026-05-07T134956Z` against local-only workbook `audit/0506.xlsx`; current buckets are `confirmed=151`, `applied=2`, `pending=144`, `block=118`, `needs_pass3=0`
- latest applied/pass3 closure is `D018 DownlinkShortGuard` via focused run `20260509T124429838816`: the final single-case rerun reports `Pass / Pass / Pass`, `diagnostic_status=Pass`, and `pass_count=1 / fail_count=0`

...
- refreshed overlay compare is now `311 / 420 full matches` / `109 mismatches` / `58 metadata drifts`
...
- next ready non-blocked compare-open case: `D197 Radio.IEEE80211hSupported`

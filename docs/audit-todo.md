...
- active audit RID is `74ada64b-2026-05-07T134956Z` against local-only workbook `audit/0506.xlsx`; current buckets are `confirmed=157`, `applied=8`, `pending=121`, `block=129`, `needs_pass3=0`
...
- next ready single-case Pass3 target is `D043` (`pass3_pending_source_survey_required`); `D005`, `D007`, `D010`, `D011`, `D023`, `D029`, `D036`, `D038`, `D040`, `D042`, and pass1-confirmed `D027` are in the confirmed bucket

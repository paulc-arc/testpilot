...
- refreshed overlay compare is now `307 / 420 full matches` / `113 mismatches` / `58 metadata drifts`
...
- next ready non-blocked compare-open case: `D193 Radio.HeCapsEnabled`

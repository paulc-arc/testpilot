...
- active audit RID is `74ada64b-2026-05-07T134956Z` against local-only workbook `audit/0506.xlsx`; current buckets are `confirmed=161`, `applied=8`, `pending=109`, `block=137`, `needs_pass3=0`

...
9. `wifi_llapi` 目前已固化 125 筆 trusted/calibrated cases，尚餘 290 筆待校正；目前明確 blockers 為 `D037 OperatingStandard`、`D054 Tx_RetransmissionsFailed`、`D055 TxBytes`。

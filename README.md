...
9. `wifi_llapi` 目前主 sweep 已固化 136 筆 trusted/calibrated cases，尚餘 279 筆待校正；目前明確 blockers 為 `D037 OperatingStandard`、`D054 Tx_RetransmissionsFailed`、`D055 TxBytes`。
